...
// Main JS Theme
function getURLVar(h) {
    var l = [];
    var f = String(document.location).split("?");
    if (f[1]) {
        var k = f[1].split("&");
        ...
        var f = String(document.location.pathname).split("/");
        if (f[f.length - 1] == "cart") {
            l.route = "checkout/cart"
        }
        if (f[f.length - 1] == "checkout") {
            l.route = "checkout/checkout"
        }
        if (l[h]) {
            return l[h]
        } else {
...
$(document).ready(function() {
    ...
    $(".btn-catalog__toggle").click(function() {
        $(this).toggleClass("active")
        $(".header-nav__submenu").toggleClass("d-flex"),
            $("main").toggleClass("on-shadow")
    });

    $(".mobile-top__menu").click(function() {
        $(this).toggleClass("active")
        $(".topinfo-list").toggleClass("show")
    });

    $(".btn-plus__circle").click(function() {
        $(this).parent().parent().toggleClass("open")
    });

    if (h.matches) {
        $(".nav-sub").hover(function() {
            $(".main-wrapper").addClass("on-shadow")
        }, function() {
            $(".main-wrapper").removeClass("on-shadow")
        });
    }
    ...
    $(".mbtn-catalog").click(function() {
        $(".catalog-category").addClass("d-flex");
    });

    $(".mobile-catalog__close").click(function() {
        $(".mobile-catalog").removeClass("d-flex");
    });
    ...
    $(".filter-block-cross").click(function() {
    ...
    $(".responsive").slick({
        ...
        slidesToShow: 5,
        slidesToScroll: 1,
        prevArrow: '<button class="prevbtn slick-btn"><i class="icmn-arrow-left8"></i></button>',
        nextArrow: '<button class="nextbtn slick-btn"><i class="icmn-arrow-right8"></i></button>',
        responsive: [{
            breakpoint: 1440,
            settings: {
                slidesToShow: 5,
    ...
    $(".search input[name='search']").parent().find("button").on("click", function() {
        ...
        var a = $("header .search input[name='search']").val();
        if (a) {
    ...
    $(".mobile-search input[name='search']").parent().find("button").on("click", function() {
        var b = $("base").attr("href") + "index.php?route=product/search";
        var a = $(".mobile-search input[name='search']").val();
        if (a) {
            b += "&search=" + encodeURIComponent(a)
        }
        location = b
    ...
    $(".mobile-search input[name='search']").on("keydown", function(a) {
        if (a.keyCode == 13) {
            $(".mobile-search input[name='search']").parent().find("button").trigger("click")
        }
    });

    var e = $("#column-right, #column-left").length;
    if (e == 2) {
        $("#content .product-module").attr("class", "product-module product-layout product-grid col-lg-4 col-md-4 col-sm-6 col-6"),
            $("#content").addClass("content-columns")
    } else {
        if (e == 1) {
            $("#content .product-module").attr("class", "product-module product-layout product-grid col-xl-3 col-lg-4 col-md-3 col-sm-6 col-6"),
                $("#content").addClass("content-column")
        } else {
            $("#content .product-module").attr("class", "product-module product-layout product-grid col-xl-20 col-lg-3 col-md-3 col-sm-4 col-6"),
    ...
    $("#grid-view").click(function() {
        ...
        if (a == 2) {
            $("#content .product-list").attr("class", "product-layout product-grid product-card col-lg-4 col-md-4 col-sm-6 col-6")
        } else {
            if (a == 1) {
                $("#content .product-list").attr("class", "product-layout product-grid product-card col-xl-3 col-lg-4 col-md-4 col-sm-6 col-6")
            } else {
                $("#content .product-list").attr("class", "product-layout product-grid product-card col-lg-20 col-md-3 col-sm-6 col-6")
            }
        }
...
var cart = {
    add: function(d, c) {
        $.ajax({
            ...
            success: function(a) {
                ...
                if (a.success) {
                    $("#content").parent().before('<div class="popupshow"><div class="alert alert-success alert-dismissible alertsuc zoomIn animated"><span class="check-success"></span>' + a.success + '<button type="button" class="close" data-dismiss="alert"><i class="icmn-cross2"></i></button></div></div>');
                    setTimeout(function() {
                        $(".cart").html(a.total)
                    }, 100);
                    $(".popupshow").delay(5000).fadeOut();
    ...
    /*
    	$(".plus").click(function (d, c){
    		$(".quant").val($(".quant").val()+1)
    		alert($(".quant").val($(".quant").val()+1))
    		update: function (d, c) {
            ...
            success: function(a) {
                ...
                if (a.success) {
                    if (a.logged) {
                        ...
                        $("#content").parent().before('<div class="popupshow"><div class="alert alert-danger alert-dismissible alertsuc zoomIn animated"><span class="check-danger"></span>' + a.success + '<button type="button" class="close" data-dismiss="alert"><i class="icmn-cross2"></i></button></div></div>')
                    }
                }
